...
function Map() {
  ...
  const handleMouseEnterRe = (e) => {
    ...
    setFilter(tagname);
    setNowArea(
      placeDataRehabilitation.find((obj) => obj.tag === tagname) || null
    );
  };
    ...
    <React.Fragment>
      <div className="tab-content" id="center-Content">
        ...
        >
          <div id="longcare-center">
            <div className="title_area">
              <h3 className="mapTitle">臺灣長照 | 據點總數</h3>
        ...
        <div
          ...
          id="rehabilitation"
          role="tabpanel"
          aria-labelledby="rehabilitation-tab"
        >
          <div id="rehabilitation-center">
            <div className="title_area">
              <h3 className="mapTitle">臺灣復健 | 據點總數</h3>
              <hr style={{ color: "black" }} />
              {nowArea && (
                <div className="forcast">
                  <h4>{nowArea.place}</h4>
