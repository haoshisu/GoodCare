...
function Mapsearch() {
  ...
  const fetchData = () => {
    axios.get(`http://localhost:8000/longcarelocation/searchlongcare`, {
      params: {
  ...
  return (
    <React.Fragment>
      <div className="search-container">
        ...
        <input
          type="text"
          className="serchtext1"
          placeholder="請輸入機構名稱關鍵字"
          value={keyword}
