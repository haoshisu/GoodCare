                ...
                <div className="tab-content" id="myTabContent">
                    <div className="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabIndex="0">
                        <div className="mb-4">
                            ...
                            <div className="row videoitem mb-4 mt-4">
                                <div className="col-4">
                                    <img src={require("../asset/images/video/video_001.jpg")} alt="thumbnail" style={{width:'100%'}} />
                                </div>      
                                <div className="col-8 d-grid">
                                    <h2>第一篇：政府為什麼要推動長照</h2>
                                    <p className="text-muted">台灣的青壯年扶養比，從1960年有21位青壯年扶養1位老人，到2015年已縮減為5.9位青壯年，推估2065年降低到1.2位青壯年...</p>
                            ...
                            <div className="row videoitem mb-4">
                                <div className="col-4">
                                    <img src={require("../asset/images/video/video_002.jpg")} alt="thumbnail" style={{width:'100%'}}/>
                                </div>
        
                                <div className="col-8 d-grid">
                                    <h2>第二篇：長照服務對象有哪些</h2>
                                    <p className="text-muted">符合資格的人可以透過三種管道，如撥打1966電話或是親自到各縣市的照管中心洽詢，還有若在醫院時，可申請長照出院準備服務...</p>
                                    <a href="#a" target="_blank" className="btn btn-lg btn-secondary btn-block">點我看影片</a>
                                </div>
                            </div>
