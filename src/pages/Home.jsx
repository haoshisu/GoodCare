          ...
          <div className="brand">
            ...
            <div className="row">
              ...
              <div className="col-5 d-flex flex-column  justify-content-center text-center">
                ...
                <h4 className="brand2">
                  &emsp;&emsp;台灣自2018年開始步入高齡社會，預計在2025年後成為超高齡社會，長照需求急遽增加下，政府也在2017年推出長照2.0政策，促進建立完善的長照體制，完備我國社會安全體系。好照顧網站平台旨在整合長照項目及長照2.0資訊，包括居家照顧、長照機構資訊、醫療輔具購買等，提供長照一條龍的安心服務。
                </h4>
              </div>
              <div className="col"></div>
